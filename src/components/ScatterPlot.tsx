...
export default function ScatterPlot() {
  ...
  useEffect(() => {
    ...
    if (filteredData.filteredUniversities.length > 0){
      uniMarker = Object.values(filteredData.filteredUniversities).map(u => u.name);
      x = Object.values(filteredData.filteredUniversities).map(u => u.qsRankingInfo.sustainability);
      y = Object.values(filteredData.filteredUniversities).map(u => u.qsRankingInfo.academic_reputation);
    }
